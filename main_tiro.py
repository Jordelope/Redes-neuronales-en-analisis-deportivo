...
archivo_clust =  r"clusterings\cltr_scout24_25_shtgStatPG_overcomplete_10cltrs.csv" # archivo CSV clusters
archivo_graf = r"clusterings\graficos\img_scout24_25_shtgStatPG_overcomplete_10cltrs.png" #archivo imagen (.png o .pdf)
